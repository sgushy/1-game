...
public class MapPanel extends JPanel {
	...
	private SMain sMain;
	   ...
	   */
	  public MapPanel(SMain s, Color foreground, Color background) {
	    super();
	    this.sMain = s;
	   ...
	   */
	  public MapPanel(Color foreground, Color background, boolean[][] texture) {
	    super();
	    ourDefaultForeground = (foreground != null ? foreground : Color.white);
	    ourDefaultBackground = (background != null ? background : getBackground());
	   ...
	   * texture map and consisting of the given foreground and background colors.
	   */
	  public MapPanel(Color foreground, Color background, boolean[][] texture, int scale) {
	    super();
	    ourDefaultForeground = (foreground != null ? foreground : Color.white);
	    ourDefaultBackground = (background != null ? background : getBackground());
	   ...
	   */
	  public MapPanel(SMain s, Image texture) {
	    super();
	    this.sMain = s;
	    ourDefaultForeground = Color.white;
	    ourDefaultBackground = getBackground();
	   ...
	   */
	  public MapPanel(Icon textureIcon) {
	    super();
	    ourDefaultForeground = Color.white;
	    ourDefaultBackground = getBackground();
	  ...
	  private void setupImagePainter(Image texture) {
	    ...
	    Graphics2D g2 = buff.createGraphics();
	    g2.drawImage(texture, w0, h0, this);
	    ourPainter = new TexturePaint(buff, new Rectangle(w0, h0, w, h));
